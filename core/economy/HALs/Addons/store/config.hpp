...
class cfgHALsStore {
	...
	class categories {
		...
		class Weapons_PP_T1 {         // Пистолеты - пулеметы Tir 1  || OK
			displayName = "Пистолеты-пулемёты";
			picture = "";
		...
		class Weapons_Rifle_T1 {      // Штурмовые винтовки Tir 1    ||
			displayName = "Штурмовые винтовки";
			picture = "";
		...
		class Weapons_Sniper_T1 {     // Снайперские винтовки Tir 1  ||
			displayName = "Снайперские винтовки";
			picture = "";
		...
		class Weapons_Launchers_T1 {  // Пусковые установки Tir 1    ||
			displayName = "Пусковые установки";
			picture = "";
		...
		class Weapons_PP_T2 {         // Пистолеты - пулеметы Tir 2
			displayName = "Пистолеты-пулеметы";
			picture = "";
	...
	class stores {
		...
		class VendorWeapon_T1 {
			displayName = "Оружие T1";
			categories[] = {
			"Weapons_Pistols_T1","Weapons_Shotguns_T1","Weapons_PP_T1","Weapons_MachineGun_T1","Weapons_Rifle_T1","Weapons_Sniper_T1","Weapons_Launchers_T1"
			};
		};

		class VendorWeapon_T2 {
			displayName = "Оружие T2";
			categories[] = {
			"Weapons_Pistols_T2","Weapons_PP_T2","Weapons_MachineGun_T2","Weapons_Rifle_T2","Weapons_Sniper_T2","Weapons_Launchers_T2"
			};
		};

		class VendorWeapon_T3 {
			displayName = "Оружие T3";
			categories[] = {
			"Weapons_Pistols_T3","Weapons_PP_T3","Weapons_MachineGun_T3","Weapons_Rifle_T3","Weapons_Sniper_T3","Weapons_Launchers_T3"
			};
		};
	};
};
