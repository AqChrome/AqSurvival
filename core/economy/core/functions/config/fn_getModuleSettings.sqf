/*
	Function: AQ_fnc_getModuleSettings
	Author: HallyG
	...
	Example:
	[
		["CfgAQTimeAcceleration"],
		"AQ_timeAcceleration_",
		[
...
private _configPath = missionConfigFile >> "cfgAQAddons";
...

{
	...
	if (count _setting > 0) then {
		private _value = [_configPath >> _setting, _default] call AQ_fnc_getConfigValue;
