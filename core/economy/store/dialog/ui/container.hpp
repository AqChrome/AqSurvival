...
class PurchaseCheckbox: RscItemCheckboxGreen {
    ...
    tooltip = "$STR_AQ_STORE_CHECKBOX_EQUIP";
	onCheckedChanged = "['button', ['enabled', []]] call AQ_store_fnc_main;";
    colorBackground[] = {0, 0, 0, 0.7};
...
class PurchaseButton: RscItemButtonAction {
    ...
    text = "$STR_AQ_STORE_BUTTON_PURCHASE";
    action = " ['button', ['pressed', []]] call AQ_store_fnc_main;";
	sizeEx = FONT(1);
};