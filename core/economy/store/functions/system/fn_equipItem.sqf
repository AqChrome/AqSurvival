/*
	Function: AQ_store_fnc_equipItem
	...
	Example:
	[player, "acc_flashlight"] call AQ_store_fnc_equipItem;
			...
			switch (_forEachIndex) do {
				case 0: {
					if ((primaryWeaponMagazine _unit) isEqualTo []) then {
						_compatibleWeaponItems = (_x call AQ_store_fnc_getCompatibleItems) apply {toLower _x};
