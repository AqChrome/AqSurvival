/*
	Function: AQ_store_fnc_getContainerCargo
	Author: HallyG
	...
	Example:
	[_container] call AQ_store_fnc_getContainerCargo;
...
private _everyContainer = everyContainer _container;
{
    ...
    _containerItems pushBack [_classname, _obj call AQ_store_fnc_getContainerCargo];
