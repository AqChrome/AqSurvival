/*
	Function: AQ_store_fnc_addContainerCargo
	Author: HallyG
	...
	Example:
	[_container, _data] call AQ_store_fnc_addContainerCargo;
...

{
    ...
    [_subContainer] call AQ_store_fnc_clearContainerCargo;
    [_subContainer, _subData] call AQ_store_fnc_addContainerCargo;
} forEach _containers;
