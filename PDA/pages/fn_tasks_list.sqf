...
private _existing = uiNamespace getVariable ["PDA_TasksGroup", controlNull];
...
["tasks", _list] call PDA_fnc_pageRegister;
...
_hdr ctrlCommit 0;
_hdr ctrlSetStructuredText parseText format ["<t shadow='0' align='center' color='#0d0d0d' font='PuristaBold' size='1.0'>%1</t>",
localize "STR_AQ_PDA_MENU_TASKS"
];
...
if (_tasks isEqualTo []) then {
  ...
  _empty ctrlCommit 0;
  _empty ctrlSetStructuredText parseText format ["<t shadow='0' color='#333333' size='0.9'>%1</t>",
  localize "STR_AQ_PDA_TASK_NOTASK"
  ];
} else {
  {
...
_back ctrlSetText (localize "STR_AQ_PDA_BUTTON_BACK");
